...
foreach ($productos as $row) {
    ...
    $data["label"] = '<div class="row mx-0 border border-secondary border-left-0 border-right-0 border-top-0">                           
                            ...
                            <img src="vistas/assets/imagenes/productos/' . $imagen_producto . '" class="border rounded-pill text-center border-secondary" style="object-fit: cover; width: 60px; height: 60px; transition: transform .2s;" alt="">
