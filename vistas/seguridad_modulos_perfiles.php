                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                            ...
                                            <button id="btnReordenarModulos" class="btn btn-success btn-sm w-25 fs-6" >Organizar Módulos</button>

                                            <button id="btnReiniciar" class="btn btn-sm btn-warning btn-sm w-25 fs-6" >Estado Inicial</button>
